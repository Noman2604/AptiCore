...
export default function DashboardFeedbackPage() {
  return (
    ...
    >
      <div className="mx-auto max-w-3xl space-y-4 px-4 pt-20 pb-12 sm:px-6 md:pt-8 lg:px-8">
        {/* Header */}
        <div>
        ...
        <div className="rounded-2xl border border-[#212a37] bg-[#10151d] p-5 sm:p-7">
          <div className="mb-5 flex items-start gap-3 border-b border-[#212a37] pb-5">
            ...
            <div>
              ...
              <p className="mt-0.5 text-[12.5px] text-[#8a96a8]">
